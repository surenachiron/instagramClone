...
import type { mostPopularUserType, PostType } from './TShowPosts';
  ...
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center bg-white rounded-lg">
        ...
        <div className="flex items-center overflow-x-auto overflow-width-scroll py-4 w-full">
          {mostPopularUsers ? (
            ...
            <div className="flex justify-between items-center w-full gap-2 overflow-x-auto overflow-width-scroll">
