    ...
    <div className="z-50">
      ...
      <dialog id="my_modal_3" className="modal">
        <div className="modal-box bg-white cursor-auto">
          ...
          <h3 className="font-bold text-lg text-center w-full">Create new Story</h3>
          <hr />
          <div className="flex flex-col items-center justify-center w-full py-8 gap-6">
            <svg fill="currentColor" height="77" role="img" viewBox="0 0 97.6 77.3" width="96">
              <path
            ...
            <Button classes="bg-blue text-white px-3 py-1 rounded-lg">Select From Computer</Button>
          </div>
        </div>
      </dialog>
    </div>
