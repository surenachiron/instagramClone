...
export const PagesDetail: { name: string; link: string; icon: React.ReactNode }[] = [
  { name: 'Home', link: '/home', icon: <GoHomeFill className="text-2xl" /> },
  { name: 'Explore', link: '/explore', icon: <MdOutlineExplore className="text-2xl" /> },
  { name: 'Reels', link: '/reels', icon: <RiMovie2Line className="text-2xl" /> },
  { name: 'Profile', link: '/profile', icon: <IoPersonCircle className="text-2xl" /> },
];
