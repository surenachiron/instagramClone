export default function InstagramSVG() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={'90px'} height={'90px'} viewBox="0 0 128 128" id="instagram-icon">
      <defs>
        <clipPath id="b">
        ...
        <radialGradient id="d" cx="27.5" cy="-41.5" r="148.5"></radialGradient>
