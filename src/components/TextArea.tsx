  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-2 relative">
        <textarea
          spellCheck={false}
          className={`w-full pl-2 pr-14 py-1 bg-white border font-light border-grayBack rounded-xl resize-none text-black ${bioLength! > +max && 'border-red-600 outline-none'}`}
